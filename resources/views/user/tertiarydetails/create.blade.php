...
<!-- Button to Add 2nd Institution -->
<button type="button" id="addSecondInstitution" class="btn btn-secondary mb-3">Add 2nd Tertiary Details</button>
...
<!-- Button to Add 3rd Institution -->
<button type="button" id="addThirdInstitution" class="btn btn-secondary mb-3" style="display: none;">Add 3rd Tertiary Details</button>
...
<script>
    document.getElementById('addSecondInstitution').addEventListener('click', function() {
        ...
        document.getElementById('addThirdInstitution').style.display = 'inline-block';
    });
