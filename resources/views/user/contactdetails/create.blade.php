...
@section('ctext','text-white')
    ...
    @endif
        ...
        @endif
        <form action="{{ route('contactdetails.store') }}" method="post" class="row g-3">
        <input type="hidden" name="app_id" readonly id="app_id" value="{{auth()->user()->app_id}}">
            ...
            <div class="col-md-4">
                ...
                <input type="tel" class="form-control" id="online_number" name="online_number" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="city_of_post_office_box" name="city_of_post_office_box">
            </div>
            <div class="col-md-4">
