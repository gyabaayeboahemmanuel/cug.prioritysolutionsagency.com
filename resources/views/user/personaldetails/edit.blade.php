...
<div class="container mt-5">
    ...
    @endif
    <form action="{{ route('personaldetails.update',auth()->user()->app_id )}}" method="post" class="row g-3 shadow p-4 bg-white rounded" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        ...
        <div class="col-12 col-lg-6">
            ...
            <select name="academic_year" class="form-select" required>
                <option value="2023/2024" {{ old('academic_year', $pd->academic_year) == '2023/2024' ? 'selected' : '' }}>2023/2024</option>
                <option value="2024/2025" {{ old('academic_year', $pd->academic_year) == '2024/2025' ? 'selected' : '' }}>2024/2025</option>
                <option value="2025/2026" {{ old('academic_year', $pd->academic_year) == '2025/2026' ? 'selected' : '' }}>2025/2026</option>
                <option value="2026/2027" {{ old('academic_year', $pd->academic_year) == '2026/2027' ? 'selected' : '' }}>2026/2027</option>
            </select>
        </div>
        ...
        <div class="col-md-6">
            ...
            <select class="form-select select2" id="country" name="country" required>
                <option value="{{ $pd->country }}" selected>{{ $pd->country }}</option>
        ...
        <div class="col-12 d-flex justify-content-between mt-4">
            ...
            @if (empty($cd->app_id))
            <a class="btn btn-success" href="{{ route('contactdetails.create') }}">
                Next <i class="material-icons">arrow_forward</i>
            </a>
            @else
            <a class="btn btn-success" href="{{ route('contactdetails.edit', $pd->app_id) }}">
                Next <i class="material-icons">arrow_forward</i>
            </a>
            @endif
        </div>
