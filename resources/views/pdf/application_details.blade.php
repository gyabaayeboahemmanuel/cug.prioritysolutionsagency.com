...
<body onload="window.print()">
    ...
    <!-- @if (!empty($pd->avatar) && file_exists(public_path('storage/' . $pd->avatar)))
    <img src="{{ public_path('storage/' . $pd->avatar) }}" width="150px" class="rounded float-left me-sm-1"
...
<hr>
    ...
    @if (!empty($at->signature))
        <img src="{{ storage_path('app/public/' . $at->signature) }}" width="50px" class="rounded float-right" alt="signature of applicant">
    @endif
</td> -->
                    </tr>
                </tbody>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- <td>
                            SIGNATURE:
                            @if (file_exists(public_path('assets/logos/ceosignature.png')))
    <img src="{{ public_path('assets/logos/ceosignature.png') }}" width="50px"
